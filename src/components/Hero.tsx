    ...
    <section className="relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 flex items-center overflow-hidden transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 dark:text-gray-300 mb-4 sm:mb-6 max-w-3xl mx-auto leading-relaxed animate-fade-in transform transition-all duration-1000 px-2" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6 sm:p-8 mx-auto max-w-2xl mb-6 sm:mb-8 animate-fade-in transform transition-all duration-1000" style={{ animationDelay: '0.3s' }}>
            ...
            <p className="text-sm sm:text-base text-white/80">
              5 days of hands-on financial education
            </p>
          </div>

          <div className="space-y-4 animate-fade-in transform transition-all duration-1000 px-2" style={{ animationDelay: '0.5s' }}>
            <Button 
              size="lg" 
            ...
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium animate-fade-in" style={{ animationDelay: '0.7s' }}>
              All supplies included • Hosted at R.H. Stafford Library
            </p>
          </div>
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto px-2">
            ...
            <div className="text-center animate-fade-in transform transition-all duration-700 hover:scale-110 relative" style={{ animationDelay: '1.1s' }}>
            ...
            <div className="text-center animate-fade-in transform transition-all duration-700 hover:scale-110 relative" style={{ animationDelay: '1.3s' }}>
            ...
            <div className="text-center animate-fade-in transform transition-all duration-700 hover:scale-110 relative" style={{ animationDelay: '1.5s' }}>
